...
export declare const companyProfile: import("drizzle-orm/pg-core").PgTableWithColumns<{
...
export declare const landingQuotes: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "landing_quotes";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "landing_quotes";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
